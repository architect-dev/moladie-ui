...
export const socials = [
  {
    ...
    //   {
    //     label: "Announcements",
    //     href: "https://t.me/SummitDefiAnnouncementsr",
    //   },
    // ],
  },
  {
    label: 'Twitter',
    icon: 'TwitterIcon',
    href: 'https://twitter.com/summitdefi',
  },
  {
    label: 'Discord',
    icon: 'DiscordIcon',
    href: 'https://discord.gg/summitdefi',
  },
  {
    label: 'Github',
    icon: 'GithubIcon',
    href: 'https://github.com/summit-defi',
  },
  {
    label: 'Medium',
    icon: 'MediumIcon',
    href: 'https://medium.summitdefi.com',
  },
]
