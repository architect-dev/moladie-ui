 ...
 */
export const estimateGas = async (contract: Contract, methodName: string, methodArgs: any[], overrides: PayableOverrides, gasMarginPer10000: number) => {
	...
	const gasEstimation = rawGasEstimation.mul(10000 + gasMarginPer10000).div(10000)
